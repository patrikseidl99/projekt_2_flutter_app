                ...
                itemBuilder: (BuildContext context, int index){
                  ...
                  child: Card(
                    ...
                    children :<Widget>[
                      ...
                      Text('cislo vzorku: ${data.sample}',style: TextStyle(fontSize: 20)),
                      Text('baterie: ${data.batt}',style: TextStyle(fontSize: 20)),
                      Text('vhlkos: ${data.hum}%',style: TextStyle(fontSize: 20)),
                      Text('tlakove cidslo1: ${data.press1}',style: TextStyle(fontSize: 20)),
                      Text('tlakove cidslo2: ${data.press2}',style: TextStyle(fontSize: 20)),
                      Text('teploty v C: ',style: TextStyle(fontSize: 20)),
